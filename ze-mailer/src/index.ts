          ...
          <tr>
            <td style="padding-bottom:40px;">
              ...
              <p style="margin:0;font-size:15px;line-height:1.7;color:#9e9e8c;font-family:Arial,sans-serif;max-width:420px;">
                Your place is reserved. Present this pass at the entrance on the evening of the exhibition.
              </p>
            </td>
          </tr>

          <tr>
            <td style="border:1px solid rgba(240,237,230,0.12);background:rgba(240,237,230,0.03);padding:32px 28px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td colspan="2" style="padding-bottom:20px;border-bottom:1px solid rgba(240,237,230,0.1);">
                    <p style="margin:0;font-family:Arial,sans-serif;font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:#9e9e8c;">Pass Details</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:16px 0 0;font-family:Arial,sans-serif;font-size:10px;letter-spacing:0.15em;text-transform:uppercase;color:#9e9e8c;">Pass Code</td>
                  <td style="padding:16px 0 0;font-family:'Courier New',monospace;font-size:14px;color:#f0ede6;text-align:right;">${code}</td>
                </tr>
                <tr>
                  <td style="padding:12px 0 0;font-family:Arial,sans-serif;font-size:10px;letter-spacing:0.15em;text-transform:uppercase;color:#9e9e8c;">Tier</td>
                  <td style="padding:12px 0 0;font-size:14px;color:#f0ede6;text-align:right;font-family:Arial,sans-serif;">${tierLabel}</td>
                </tr>
                <tr>
                  <td style="padding:12px 0 0;font-family:Arial,sans-serif;font-size:10px;letter-spacing:0.15em;text-transform:uppercase;color:#9e9e8c;">Name</td>
                  <td style="padding:12px 0 0;font-size:14px;color:#f0ede6;text-align:right;font-family:Arial,sans-serif;">${name}</td>
                </tr>
                <tr>
                  <td style="padding:12px 0 0;font-family:Arial,sans-serif;font-size:10px;letter-spacing:0.15em;text-transform:uppercase;color:#9e9e8c;">Date</td>
                  <td style="padding:12px 0 0;font-size:14px;color:#f0ede6;text-align:right;font-family:Arial,sans-serif;">14 · 08 · 2026</td>
                </tr>
              </table>
            </td>
          </tr>
          ...
          ${qr ? `<tr>
            <td align="center" style="padding:32px 0;">
              <table cellpadding="0" cellspacing="0" style="background:#f0ede6;padding:20px;">
                <tr>
                  <td>
                    <img src="${qr}" alt="QR Pass" width="200" height="200" style="display:block;width:200px;height:200px;" />
                  </td>
                </tr>
                <tr>
...
function corsResponse(body: string | null, status: number): Response {
	return new Response(body, {
		...
		headers: {
			"Content-Type": "application/json",
			"Access-Control-Allow-Origin": "https://houseofze.com",
