...
const packages = [
  {
    ...
    perks: [
      ...
      "10 general invitations",
      "Brand mention in opening remarks",
      "Social channel feature (1 post)",
    ],
  },
  {
    name: "Salon",
    ...
    color: "border-rose",
    perks: [
      "Co-branded installation room",
      "20 VIP invitations · 10 general",
      "Press release inclusion",
      "Bespoke editorial content (3 pieces)",
      "Atelier dinner seating",
    ],
  },
  {
    name: "Couture",
    ...
    color: "border-ink/15",
    perks: [
      "Title partnership of the exhibition",
      "Unlimited VIP access",
      "Naming of a flagship installation",
